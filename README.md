fisk.py - simple fiscalization (Fiskalizacija) library for Croatia (Hrvatska)


**Note1:** This is a fork of kodmasin's fiskpy, designed to support python 3.5 (It should work with pyhton > 3.0, atlhough it wasn't tested). Link to original fiskpy for python 2.7:
...
- Added support for Python 3.5 (backward compatibility compromised)
